...
function search(category) {
  ...
  document.getElementById("title").innerHTML = capitalize(category)
  document.getElementById("page").innerHTML = capitalize(category)
  //navs badges
...
function navbarCategory(category) {

  const navactive = category + "nav";
  const matches = document.getElementsByClassName("nav-link badge-primary");



  document.getElementById(navactive).className = "nav-link badge-primary";
}